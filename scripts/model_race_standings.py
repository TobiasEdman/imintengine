...
def main() -> None:
    ...
    print(f"\nwrote {out}  ·  LUCAS column pending L2")
    print("NOTE: frac-capable backbones (Tessera; later CROMA/TerraMind) are "
          "scored HARD here; their apples-to-apples FRACTION number needs a "
          "--use-fraction-head dump (small, per model).")
