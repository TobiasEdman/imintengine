...
_DISTILL_DEPS_PINNED = """pip install --quiet --no-cache-dir --no-deps torch==2.5.1 torchvision==0.20.1 \\
                --index-url https://download.pytorch.org/whl/cu121
              pip install --quiet --no-cache-dir --no-deps \\
                Jinja2==3.1.6 MarkupSafe==3.0.3 PyYAML==6.0.2 affine==3.0.1 \\
                attrs==26.1.0 certifi==2026.7.22 charset-normalizer==3.5.1 \\
                click-plugins==1.1.1.2 click==8.5.0 cligj==0.7.2 cloudpickle==3.1.2 \\
                einops==0.8.0 filelock==3.32.5 fsspec==2026.7.0 \\
                huggingface-hub==0.26.2 idna==3.19 joblib==1.6.0 mpmath==1.3.0 \\
                networkx==3.6.1 numpy==1.26.4 packaging==26.3 pandas==2.2.2 \\
                pillow==10.4.0 pyarrow==17.0.0 pyparsing==3.3.2 pyproj==3.6.1 \\
                python-dateutil==2.9.0.post0 pytz==2026.3.post1 rasterio==1.3.11 \\
                ...
                typing_extensions==4.16.0 tzdata==2026.3 urllib3==2.7.0"""
