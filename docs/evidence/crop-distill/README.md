...
reviewed image and strictly verified against their current Git pins. The
attempt-16 split verifier and exact restore have also succeeded. The frozen
split manifest is pinned in Git; the six crop-consumer Jobs are generated but
...
| crop consumers | not run | six digest-pinned Job manifests generated by consumer-authorization commit E; launch remains a separate reviewed action |
