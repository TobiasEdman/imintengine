...
| next split verifier retry and crop consumers | not run | blocked on exact failed-lease restore and watchdog execution that does not share the interactive session process lifetime |
