...
| next split verifier retry and crop consumers | not run | blocked on exact-SHA review of bounded watchdog `kubectl` requests/processes; the 180-second lease is unchanged |
